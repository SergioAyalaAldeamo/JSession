...
public class MenuServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(u == null){
            ...
            errors.add(new Error(400, "Debe iniciar sesión para acceder al menú"));
        ...
        try {
            ...
            out.println("<a href='registrarTrabajador.jsp'>Registrar Trabajador</a><br/>");
            out.println("<a href='listarTrabajador.view'>Listar trabajadores</a><br/>");
