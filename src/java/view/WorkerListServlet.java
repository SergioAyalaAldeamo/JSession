                ...
                out.println("<table border='1'>");
                    ...
                    for(Worker w : workers){
                        out.println("<tr>");
                            ...
                            out.println("<td>$"+w.getSueldoBase()+"</td>");
                            out.println("<td>$"+w.getAfp()+"</td>");
                            out.println("<td>$"+w.getSalud()+"</td>");
                            out.println("<td>$"+w.BONO_PRODUCCION+"</td>");
                            out.println("<td>$"+w.getAguinaldo()+"</td>");
                            out.println("<td>$"+w.getSueldoLiquido()+"</td>");
                        out.println("</tr>");
                    }
                out.println("</table>");
